public class BonusEmployee extends Employee {
    public BonusEmployee(String name, String uan, String employeeID, String pfNo, String designation, String esiNo,
    ...
    {
        return calculateTotalEarnings()-calculateTotalDeductions() + 0.2*(calculateTotalEarnings()-calculateTotalDeductions());
    }
